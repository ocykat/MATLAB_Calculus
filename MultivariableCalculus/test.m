...
min_z = subs(f, {x, y}, {critical_points.x(1), critical_points.y(1)});
max_z = subs(f, {x, y}, {critical_points.x(1), critical_points.y(1)});

for i = 2 : numel(critical_points.x)
    x_i = critical_points.x(i);
    y_i = critical_points.y(i);
    z_i = subs(f, {x, y}, {critical_points.x(i), critical_points.y(i)});;
